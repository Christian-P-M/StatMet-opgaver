...
hest <- lm(NDVI~ (climate_zone+season)*prev_month_air_temperature*prev_month_soil_temperature*prev_month_moisture, data = data1)
get_regression_table(hest)


```
Bliver vidst nød til at kontrollere om dette er en mulig model:
```{r}
